...
void Dijkstra(int graph[4][4],int src) // adjacency matrix used is 4x4
{
	int dist[4]; // integer array to calculate minimum distance for each node.
	bool Tset[4];// boolean array to mark visted/unvisted for each node.
